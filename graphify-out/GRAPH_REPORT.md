...
## Corpus Check
- 62 files · ~39,626 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 963 nodes · 1063 edges · 31 communities (16 shown, 15 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c7e18ba8`
...
10. `Prisma__BookingClient` - 7 edges
...
### Community 6 - "api.ts"
Cohesion: 0.06
Nodes (37): bookSeats(), getEvent(), getEvents(), getMe(), getSeats(), getShow(), getTickets(), login() (+29 more)
...
### Community 8 - "app.ts"
Cohesion: 0.08
Nodes (25): events, allowedOrigins, app, getEvent(), getEvents(), getSeats(), getShow(), Booking (+17 more)

### Community 9 - "auth.route.ts"
Cohesion: 0.10
Nodes (28): getMe(), login(), logout(), signup(), bookSeats(), getTickets(), AuthResponse, UserResponse (+20 more)

### Community 10 - "dependencies"
Cohesion: 0.05
Nodes (37): author, dependencies, bcrypt, cookie-parser, cors, dotenv, express, express-rate-limit (+29 more)
...
## Knowledge Gaps
- **698 isolated node(s):** `eslintConfig`, `nextConfig`, `name`, `version`, `private` (+693 more)
