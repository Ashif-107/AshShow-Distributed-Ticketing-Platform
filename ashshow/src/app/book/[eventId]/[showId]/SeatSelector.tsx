        ...
        <div className="border-4 border-black bg-cyan-300 p-8 shadow-[8px_8px_0px_0px_black]">
            ...
            <div className="mt-8 text-center">
                <button
                    ...
                    className={`inline-block border-4 border-black px-16 py-5 text-2xl font-black uppercase tracking-wide shadow-[8px_8px_0px_0px_black] transition-all ${selectedSeats.length === 0
